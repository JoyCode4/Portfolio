"use client"
import { ArrowRight, ArrowLeft, Github, Linkedin, Mail, Phone } from 'lucide-react';
      ...
      <div className="page-container bg-dark-gray text-white">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between">
              <div className="mb-12 lg:mb-0 max-w-3xl">
                ...
                <p className="text-light-gray text-lg max-w-xl mb-8 leading-relaxed">
                  I craft scalable, maintainable web applications across the full stack &mdash; from polished
                  UIs in React and Next.js to robust APIs in Node.js, FastAPI and C#&nbsp;/&nbsp;SQL Server.
                </p>
        ...
        <section className="section-container py-12 overflow-hidden relative">
          ...
          <div className="relative flex space-x-6 overflow-x-auto pb-6 scrollbar-hide">
            <ProjectPreview
              title="AI Document Q&A — chat with your documents"
              image="/assets/AI3.png"
              direction="right"
              href="https://aidocqa.vercel.app/"
            />
            <ProjectPreview
              title="E-Commerce Platform — Next.js + Redux Toolkit"
              image="/assets/ECom1.png"
              direction="none"
              href="https://ecommerce-jayesh-app.vercel.app/"
            />
            <ProjectPreview
              title="Budget Planner — secure financial web app"
              image="/assets/Budget2.png"
              direction="right"
              href="https://budget-planner-frontend-app.vercel.app/"
            />
          </div>
        </section>
        ...
        <section className="section-container py-16 relative">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-8">
            <div className="lg:w-1/2">
              <h3 className="text-xl mb-4">Hello! I'm Jayesh, I'm a <span className="font-semibold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">full-stack software engineer</span>.</h3>
              <p className="text-light-gray">B.E. CSE (CGPA 9.04) &middot; Software Engineer @ Yardi &middot; ex Coding Ninjas.</p>
              ...
              <div className="mt-12 space-y-6">
                <div className="backdrop-blur-sm bg-black/20 border border-white/10 rounded-xl p-6 shadow-lg hover:shadow-purple-500/20 transition-all duration-300 hover:border-purple-500/30 transform hover:translate-y-[-2px]">
                  <h4 className="mb-4 text-purple-300">Languages</h4>
                  <div className="flex flex-wrap gap-2">
                    {["C#", "Java", "JavaScript", "TypeScript", "SQL", "Python"].map((skill) => (
                      <span key={skill} className="text-sm text-gray-400 hover:text-purple-200 transition-colors duration-300">/ {skill} </span>
                    ))}
                  </div>
                </div>
                ...
                <div className="backdrop-blur-sm bg-black/20 border border-white/10 rounded-xl p-6 shadow-lg hover:shadow-blue-500/20 transition-all duration-300 hover:border-blue-500/30 transform hover:translate-y-[-2px]">
                  <h4 className="mb-4 text-blue-300">Frameworks & Libraries</h4>
                  <div className="flex flex-wrap gap-2">
                    {["Angular", "React.js", "Next.js", "Node.js", "Express.js", "LangChain", "FastAPI", "Redux Toolkit"].map((skill) => (
                      <span key={skill} className="text-sm text-gray-400 hover:text-blue-200 transition-colors duration-300">/ {skill} </span>
                    ))}
                  </div>
                </div>
                ...
                <div className="backdrop-blur-sm bg-black/20 border border-white/10 rounded-xl p-6 shadow-lg hover:shadow-green-500/20 transition-all duration-300 hover:border-green-500/30 transform hover:translate-y-[-2px]">
                  <h4 className="mb-4 text-green-300">Web & Databases</h4>
                  <div className="flex flex-wrap gap-2">
                    {["HTML", "CSS", "Tailwind CSS", "Bootstrap", "REST APIs", "JWT", "SQL Server", "MongoDB", "FAISS"].map((skill) => (
                      <span key={skill} className="text-sm text-gray-400 hover:text-green-200 transition-colors duration-300">/ {skill} </span>
                    ))}
                  </div>
                </div>
                ...
                <div className="backdrop-blur-sm bg-black/20 border border-white/10 rounded-xl p-6 shadow-lg hover:shadow-orange-500/20 transition-all duration-300 hover:border-orange-500/30 transform hover:translate-y-[-2px]">
                  <h4 className="mb-4 text-orange-300">Tools & Platforms</h4>
                  <div className="flex flex-wrap gap-2">
                    {["Git", "GitHub", "Postman", "TFS", "Render", "Netlify", "Vercel"].map((skill) => (
                      <span key={skill} className="text-sm text-gray-400 hover:text-orange-200 transition-colors duration-300">/ {skill} </span>
                    ))}
                  </div>
                </div>
              </div>
            ...
            <div className="lg:w-1/2">
              ...
              <div className="relative flex items-center justify-center mb-10">
                ...
                <div className="relative w-60 h-60 flex items-center justify-center">
                  ...
                  <div className="absolute top-1/4 -right-8 px-3 py-1 bg-black/40 backdrop-blur-sm rounded-full text-xs text-blue-300 border border-blue-500/30 shadow-lg shadow-blue-500/20">Angular</div>
                  <div className="absolute -bottom-2 -right-6 px-3 py-1 bg-black/40 backdrop-blur-sm rounded-full text-xs text-green-300 border border-green-500/30 shadow-lg shadow-green-500/20">C# / .NET</div>
                  <div className="absolute bottom-1/4 -left-12 px-3 py-1 bg-black/40 backdrop-blur-sm rounded-full text-xs text-pink-300 border border-pink-500/30 shadow-lg shadow-pink-500/20">Next.js</div>
                  ...
                  <Avatar className="w-48 h-48 border-4 border-white/10 shadow-2xl shadow-purple-500/30 hover:shadow-purple-500/50 transition-all duration-500 hover:scale-105">
                    <AvatarImage src="/assets/profile.gif" alt="Jayesh Profile" className="object-cover" />
              ...
              <div className="mt-4">
                ...
                <div className="mt-4 text-right">
                  <p className="text-light-gray">Total work experience</p>
                  <p className="font-semibold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">2+ years</p>
                </div>
              </div>
            </div>
          </div>
...
const ProjectPreview = ({
  ...
  const commonClass = "flex-shrink-0 w-80 h-32 relative rounded-xl overflow-hidden group shadow-lg hover:shadow-purple-500/30 transition-all duration-300 transform hover:scale-[1.03] border border-white/5 hover:border-purple-500/20 block";
    ...
    <>
      ...
      <div className="absolute inset-0 z-20 p-4 flex flex-col justify-between">
        ...
        <div className="flex justify-between items-center">
          <span className="text-xs text-white bg-purple-600/90 px-3 py-1 rounded-full group-hover:bg-purple-500 transition-colors shadow-md group-hover:shadow-purple-500/50">
            Read more
          </span>
